...
public class FeatureFilter implements Filter {
	...
	if (debug) log("FeatureFilter:DoBeforeProcessing");
	...
	*/
	...
	throws IOException, ServletException {
	if (debug) log("FeatureFilter:DoAfterProcessing");
	...
	*/
	...
	if (debug) log("FeatureFilter:doFilter()");
	...
	if (filterConfig != null) {
	    if (debug) { 
		log("FeatureFilter:Initializing filter");
	    }
	}
    }
	...
	if (filterConfig == null) return ("FeatureFilter()");
	StringBuffer sb = new StringBuffer("FeatureFilter(");
